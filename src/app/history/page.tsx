        ...
        <div className="px-4 pt-4 pb-6">
          ...
          <div className="px-1 mb-5">
            <div className="flex justify-between items-start">
              <div>
                <h1 className="text-2xl font-extrabold font-serif text-bo-ink m-0 mb-1">Myコスメ</h1>
                  ...
                  {filtered.map((p, i) => {
                    ...
                    return (
                      <div
                        ...
                        className="rounded-r2 overflow-hidden bg-white border border-bo-parchment shadow-bo1 cursor-pointer animate-fade-up transition-transform duration-200"
                      ...
                      >
                        <div className="relative aspect-square bg-bo-parchment overflow-hidden">
                          ...
                          <div className="absolute top-2 right-2 w-7 h-7 rounded-full bg-white/85 backdrop-blur-lg flex items-center justify-center text-[13px]">
                            {p.isFavorite ? "❤️" : "🤍"}
                          </div>
                          {genre && (
                  ...
                  {filtered.map((p, i) => {
                    ...
                    return (
                      <div
                        key={p.id}
                        onClick={() => setSelectedProduct(p)}
                        className="flex items-center gap-3 py-2.5 px-3 bg-white rounded-r1 border border-bo-parchment shadow-bo1 cursor-pointer animate-fade-up"
                      ...
                      >
                        ...
                        <div className="flex flex-col items-end gap-1 shrink-0">
                          <span className="text-sm">{p.isFavorite ? "❤️" : "🤍"}</span>
          ...
          {favCount > 0 && (
            <div
              ...
              className="mt-6 mx-1 py-4 px-4.5 rounded-r2 bg-bo-accent-soft border border-bo-accent/15 flex items-center gap-3 cursor-pointer"
            >
              <span className="text-xl">🐦</span>
              <div className="flex-1">
                <div className="text-xs font-bold text-bo-ink font-sans">お気に入りをXでシェア</div>
                <div className="text-[10px] text-bo-ink-muted font-sans mt-0.5">キャプチャ画像付きで投稿できます</div>
              </div>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3A8F7A" strokeWidth="2" strokeLinecap="round" aria-hidden="true">
