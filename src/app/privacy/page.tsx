...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      "成分図鑑・マイスキンケアデッキ・ルーティンチェックリスト機能の提供",
      "スキャン回数の管理（利用上限管理）",
    ...
    subsections: [
      ...
      },
      {
        ...
        items: [
          ...
          "利用目的：Googleアカウントによるログイン認証、Google Gemini APIによるAI成分解析・画像認識",
          "※画像はAI解析処理のために送信されます。Googleの利用規約・プライバシーポリシーに従いデータが取り扱われます。",
        ],
      },
      {
      ...
      <div className="px-5 pt-8 pb-16 max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs" style={{ color: "#9B9B9B" }}>
            制定日：2026年4月4日　最終更新日：2026年4月10日
          </p>
        </div>
