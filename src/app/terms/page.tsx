...
const sections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "ユーザーは、設定画面からいつでもアカウントを削除することができます。アカウント削除時には、関連するすべてのデータ（コスメデータ、図鑑データ、スキンケアデッキデータ、スキャン履歴、成分プロファイル、X連携トークン、アップロード画像等）が完全に削除され、復元はできません。",
    ],
  },
  {
    title: "第4条（サービス内容）",
    ...
    paragraphsAfter: [
      "無料アカウントにつきスキャン回数は30回までとなります。機能や利用条件は今後変更される場合があります。",
    ],
  },
  {
    title: "第5条（禁止事項）",
