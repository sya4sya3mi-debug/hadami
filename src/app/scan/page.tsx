...
const IdentifyStep = dynamic(() => import("@/components/scan/IdentifyStep"), { ssr: false });
const ClassifyStep = dynamic(() => import("@/components/scan/ClassifyStep"), { ssr: false });
const ScanResult = dynamic(() => import("@/components/scan/ScanResult"), { ssr: false });
const ScanDiscoveryAd = dynamic(() => import("@/components/recommendations/ScanDiscoveryAd"), { ssr: false });
const ManualInputSheet = dynamic(() => import("@/components/scan/ManualInputSheet"), { ssr: false });
const DiscoveryModal = dynamic(() => import("@/components/ui/DiscoveryModal"), { ssr: false });
