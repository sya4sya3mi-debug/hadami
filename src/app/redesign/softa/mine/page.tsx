...
export default function MineSoftA() {
        ...
        <Screen>
          ...
          <div style={{ padding: "4px 24px 16px" }}>
            ...
            >
              ...
              {/* View toggle — A pure (sharp segmented) */}
                      ...
                      >
                        <div
                          style={{
                            ...
                            background: g.fav ? "var(--hd-ink)" : "rgba(255,255,255,0.92)",
                        ...
                        <div
                          style={{
                            width: 26, height: 26, borderRadius: 999,
                            background: "rgba(255,255,255,0.92)", color: "var(--hd-ink-40)",
                            display: "flex", alignItems: "center", justifyContent: "center",
                          }}
