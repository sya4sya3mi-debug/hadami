...
export default function ZukanSoftA() {
      ...
      <div className="hd-softa" style={{ height: "100%" }}>
        <Screen>
          ...
          <div style={{ padding: "4px 24px 18px" }}>
            ...
            {/* Progress block — A pure (hairline rule) */}
            <div
              style={{
              ...
              {[
                ...
                <button
                  ...
                  style={{
                    ...
                    borderBottom: activeTab === t.id ? "1.5px solid var(--hd-ink)" : "1.5px solid transparent",
          ...
          <div style={{ flex: 1, overflow: "auto" }}>
            ...
            >
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 14 }}>
                <Thumb p={PRODUCTS.dhc} size={56} radius={12} apo />
            ...
            <div style={{ padding: "24px" }}>
              {INGREDIENTS.map((ing, i) => (
                <div
                  ...
                  style={{
                    padding: "16px 0",
                    borderBottom: i < INGREDIENTS.length - 1 ? "1px solid var(--hd-hair)" : "none",
