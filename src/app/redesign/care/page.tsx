        ...
        <div style={{ padding: "4px 24px 20px" }}>
          ...
          >
            <div>
              ...
              <div
                className="hd-serif"
                style={{ marginTop: 4, letterSpacing: "-0.02em", fontSize: 28, lineHeight: 1.05 }}
              >
                スキンケア<br />
              ...
              <React.Fragment key={i}>
                ...
                <div
                  style={{
                    ...
                    borderBottom: i < STEPS.length - 1 ? "1px solid var(--hd-hair)" : "none",
                  }}
                >
                  <div
                    className="hd-mono"
                    style={{ width: 24, fontSize: 11, color: "var(--hd-ink-40)" }}
                  >{s.no}</div>
                  {s.empty || !p ? (
                    <>
                      <div
